...
public class ReleaseOwnershipFunctionalityWithPreliminaryDecision implements Scenario<DecisionEngineWorkflowPage, DewPendingPaymentsPage> 
{
	@Override
	...
	return entry
				...
				//	.dewProductLoginAlertAutentication(ICSPropertiesConfig.getDewUsername(), ICSPropertiesConfig.getDewPassword())
					...
					.valuetextComments()
					.clickbtnPass()
					.validateItemOwnershipAfterPreliminaryDecision()
