 ...
 DECLARE @Request VARCHAR(MAX)
  ...
  DECLARE @Command NVARCHAR(500);
    ...
    INSERT  INTO @Files
            EXEC [master].[sys].[xp_dirtree] 'W:\Incomingdebits_Automation\LBG-Arbuthnot1\', 1, 1;
   ...
   FROM    @Files;
    ...
    BEGIN	
        ...
        SET @Command = N'SELECT @Document = [BulkColumn] FROM OPENROWSET(BULK ''W:\Incomingdebits_Automation\LBG-Arbuthnot1\' + @FileName + ''', SINGLE_CLOB) AS XmlDocument';
