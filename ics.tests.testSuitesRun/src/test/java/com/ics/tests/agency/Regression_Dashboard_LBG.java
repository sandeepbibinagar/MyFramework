 ...
 * Created By -  RamuDeep
 ************************************************************************ 
 * Description - TestScripts to check the Functionality of Dashboard screen for LBG
 ***********************************************************************/
 ...
 ***********************************************************************
  * Description - 
 ***********************************************************************/
public class Regression_Dashboard_LBG extends ICSAutomationCommonSetup{
	...
	public static String path_LBG_IncomingDebits_completed=getAgencyDataFromPath("dashboard")+getAgencyResourceFile().getString("debitsCompletedLbg");
	public static String path_LBG_IncomingDebits_kappadecision=getAgencyDataFromPath("dashboard")+getAgencyResourceFile().getString("debitsKappaLbg");
	public static String path_LBG_IncomingDebits_paymentdecision=getAgencyDataFromPath("dashboard")+getAgencyResourceFile().getString("debitsPayLbg");
	
	public static String path_LBG_IncomingCredits_CollectedElsewhere=getAgencyDataFromPath("dashboard")+getAgencyResourceFile().getString("creditsCollectedElsewhereLbg");
	public static String path_LBG_IncomingCredits_CollectedByMe=getAgencyDataFromPath("dashboard")+getAgencyResourceFile().getString("creditsCollectedByMeLbg");
	 ...
	 */
	@Test(priority = 1)
	public void test_case_lbg_incomingDebits_completedItems() throws Exception
	{
		new DashboardPage(DRIVER)
		.dataLoad_IA_deleteScript();
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingDebits_completed,dashboard_06MA01);
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingDebits_completed,dashboard_06MA02);
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingDebits_completed,dashboard_06MA03);
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingDebits_completed,dashboard_06MA04);
	 ...
	 */
	@Test(priority = 2)
	public void test_case_lbg_incomingDebits_payDecisionItems() throws Exception
	{
		new DashboardPage(DRIVER)
		.dataLoad_IA_deleteScript();
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingDebits_paymentdecision,dashboard_06MA01);
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingDebits_paymentdecision,dashboard_06MA02);
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingDebits_paymentdecision,dashboard_06MA03);
		new AgencyIdentityProviderPage(DRIVER, getAgencyValueFromDataSheet("URL"))
		.run(new OpenAgencyPageScenario(ICSPropertiesConfig.getInclearingDescisioner()));
		new OpenAgencyPortalPage(DRIVER)
		.clickOpenAgencyPortalButton()
	...
	public void test_case_hsbc_incomingDebits_kappaDecisionItems() throws Exception
	{
		new DashboardPage(DRIVER)
		.dataLoad_IA_deleteScript();
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingDebits_kappadecision,dashboard_06MA01);
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingDebits_kappadecision,dashboard_06MA02);
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingDebits_kappadecision,dashboard_06MA03);
//		new AgencyIdentityProviderPage(DRIVER, getAgencyValueFromDataSheet("URL"))
//		.run(new OpenAgencyPageScenario(ICSPropertiesConfig.getInclearingDescisioner()));
//		new OpenAgencyPortalPage(DRIVER)
//		.clickOpenAgencyPortalButton()
...
//		.verifyLandingPageDashboardKappaDecision();
	...
	/* Test Case: 105352
	 * Author:Deepa Ramu
	 * Description: Dashboard(Incoming Debits): Regression: Integration - Verify value of all debit items worked on the current day is displayed
	 * Expected: 
	 *   1. Field should be populated with value equal to sum of all items for current day
	 */
	@Test(priority = 4)
	public void test_case_lbg_incomingDebits_allCurrentDayItems() throws Exception
	{
		new DashboardPage(DRIVER)
		.dataLoad_IA_deleteScript();
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingDebits_completed,dashboard_06MA01);
		...
		.switchToAgencyFrame();
		new DashboardPage(DRIVER)
		.verifyLandingPageDashboardTotal();
	}
	 ...
	 */
	@Test(priority = 5)
	public void test_case_lbg_incomingCredits_collectedElsewhere() throws Exception
	{
		new DashboardPage(DRIVER)
		.dataLoad_IA_deleteScript();
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingCredits_CollectedElsewhere,dashboard_05MA01);
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingCredits_CollectedElsewhere,dashboard_05MA03);
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingCredits_CollectedElsewhere,dashboard_13MA01);
		runStoredProcedureCall(server,IA_db,path_LBG_IncomingCredits_CollectedElsewhere,dashboard_13MA04);
		new AgencyIdentityProviderPage(DRIVER, getAgencyValueFromDataSheet("URL"))
	...
	/* Test Case: 104804, 104814
	 * Author:Deepa Ramu
	 * Description: Dashboard(Incoming Credits): Regression: Integration - Verify value of all credit items is displayed on dashboard(collecetdByMe)
	 * Expected: 
	 *   1. collected by me items should be displayed
	 */
//	@Test(priority = 6)
//	public void test_case_hsbc_incomingCredits_collectedItems() throws Exception
//	{
//		new DashboardPage(DRIVER)
//		.dataLoad_IA_deleteScript();
//		runStoredProcedureCall(server,IA_db,path_LBG_IncomingCredits_CollectedByMe,dashboard_06MA01);
//		new AgencyIdentityProviderPage(DRIVER, getAgencyValueFromDataSheet("URL"))
//		.run(new OpenAgencyPageScenario(ICSPropertiesConfig.getInclearingDescisioner()));
//		new OpenAgencyPortalPage(DRIVER)
//		.clickOpenAgencyPortalButton()
...
//	}
	 ...
	 */
//	@Test(priority = 7)
//	public void test_case_hsbc_incomingCredits_allCurrentDayItems() throws Exception
//	{
//		new DashboardPage(DRIVER)
//		.dataLoad_IA_deleteScript();
//		runStoredProcedureCall(server,IA_db,path_HSBC_IncomingCredits_CollectedByMe,dashboard_06MA01);
//		runStoredProcedureCall(server,IA_db,path_HSBC_IncomingCredits_CollectedElsewhere,dashboard_06MA01);
//		new AgencyIdentityProviderPage(DRIVER, getAgencyValueFromDataSheet("URL"))
//		.run(new OpenAgencyPageScenario(ICSPropertiesConfig.getInclearingDescisioner()));
//		new OpenAgencyPortalPage(DRIVER)
//		.clickOpenAgencyPortalButton()
...
//	}
	 ...
	 */
	@Test(priority = 8)
	public void test_case_lbg_incomingCredits_refresh() throws Exception
	{
	 ...
	 */
	@Test(priority = 9)
	public void test_case_lbg_incomingDebits_refresh() throws Exception
	{
		String query = getAgencyValueFromDataSheet("configTimeInterval1");
		ICSProductDBConnection.getICSDBServerConnection(serverAgency, db, query);
		new DashboardPage(DRIVER)
