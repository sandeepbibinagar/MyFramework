...
public class ValidateAIXMLWithMutipleItems extends ICSDBUtilis{
		...
		/*******************************************************************************************************************************************/
		public static String aixmlFileNameCreated;
		...
		public static void validateAIXMLFileMovedToArchieveFldr(String dbServerName,String fredDBName,String templateFilePath,String ICNFilepath,String fredaixmlTmpltFilename,String ICNFileName,String fredAIXMLFilePath,String aixmlArchvFilePath) throws Exception,NullPointerException{
		 ...
		 * Description: Test Step 6 :Verify AIXML File Details are loaded into Job table
		 /*******************************************************************************************************************************************/
		...
		public static void validateAIXMLJobStartTimeWithDb(String dbServerName,String fredDBName,String templateFilePath,String ICNFilepath,String fredaixmlTmpltFilename,String ICNFileName,String fredAIXMLFilePath,String aixmlArchvFilePath) throws Exception{
			...
			Map<String, String> aixmljobWrkTypeNodeVal = getXMLNodeValueByXPATH(aixmlArchvFilePath,aixmlFileNameCreated,xpathAIXMLJobWorkTypeNumber);
			List<String> litsOfNodeWrkTypeNbrAIXML = getNodeListValues(aixmljobWrkTypeNodeVal,"StartTime");
			System.out.println("AIXML Job StartTime list values returned: "+litsOfNodeWrkTypeNbrAIXML);
			String xmlNodeVal = litsOfNodeWrkTypeNbrAIXML.get(0);
			...
			boolean returnExpectedReslt = Component.verifyEquals(actualjobWrkTypNbrVal, xmlNodeVal, "Job StartTime Number of the aixml file is not loaded into database.");
			publishResults(returnExpectedReslt, actualjobWrkTypNbrVal, xmlNodeVal, "Job StartTime Number of the aixml file is loaded into database.");
		}
		...
		public static void validateAIXMLJobEndTimeWithDb(String dbServerName,String fredDBName,String templateFilePath,String ICNFilepath,String fredaixmlTmpltFilename,String ICNFileName,String fredAIXMLFilePath,String aixmlArchvFilePath) throws Exception{
			...
			Map<String, String> aixmljobWrkTypeNodeVal = getXMLNodeValueByXPATH(aixmlArchvFilePath,aixmlFileNameCreated,xpathAIXMLJobWorkTypeNumber);
			List<String> litsOfNodeWrkTypeNbrAIXML = getNodeListValues(aixmljobWrkTypeNodeVal,"EndTime");
			System.out.println("AIXML Job EndTime list values returned: "+litsOfNodeWrkTypeNbrAIXML);
			String xmlNodeVal = litsOfNodeWrkTypeNbrAIXML.get(0);
			...
			boolean returnExpectedReslt = Component.verifyEquals(actualjobWrkTypNbrVal, xmlNodeVal, "Job EndTime Number of the aixml file is not loaded into database.");
			publishResults(returnExpectedReslt, actualjobWrkTypNbrVal, xmlNodeVal, "Job EndTime Number of the aixml file is loaded into database.");
		}
		...
		public static void validateAIXMLJobCollectionStartTimeWithDb(String dbServerName,String fredDBName,String templateFilePath,String ICNFilepath,String fredaixmlTmpltFilename,String ICNFileName,String fredAIXMLFilePath,String aixmlArchvFilePath) throws Exception{
			ArrayList<String> returnVal = new ArrayList<>();
			String xpathAIXMLJobWorkTypeNumber ="//Jobs/Job/CollectionStartTime";
			Map<String, String> aixmljobWrkTypeNodeVal = getXMLNodeValueByXPATH(aixmlArchvFilePath,aixmlFileNameCreated,xpathAIXMLJobWorkTypeNumber);
			List<String> litsOfNodeWrkTypeNbrAIXML = getNodeListValues(aixmljobWrkTypeNodeVal,"CollectionStartTime");
			System.out.println("AIXML Job CollectionStartTime list values returned: "+litsOfNodeWrkTypeNbrAIXML);
			
			String xmlNodeVal = litsOfNodeWrkTypeNbrAIXML.get(0);
			
			String jobWrkTypNbrQuery ="select CollectionStartTime from Base.AIXMLJobs where FileName='"+aixmlFileNameCreated+"'";
			System.out.println("Job CollectionStartTime Query : "+jobWrkTypNbrQuery);
			ResultSet rsjobWrkTypNbr = ICSProductDBConnection.getICSDBServerConnection(dbServerName, fredDBName, jobWrkTypNbrQuery);
			String  actualjobWrkTypNbrVal = GenericMethods.getICSRetrieveColumnValues(rsjobWrkTypNbr);
			...
			boolean returnExpectedReslt = Component.verifyEquals(actualjobWrkTypNbrVal, xmlNodeVal, "Job CollectionStartTime of the aixml file is not loaded into database.");
			publishResults(returnExpectedReslt, actualjobWrkTypNbrVal, xmlNodeVal, "Job CollectionStartTime of the aixml file is loaded into database.");
		}
		...
		public static void verifyErrorLog06MF01(String dbServerName,String fredDBName,String templateFilePath,String ICNFilepath,String fredaixmlTmpltFilename,String ICNFileName,String fredAIXMLFilePath,String aixmlArchvFilePath) throws Exception{
			...
			String errorLogQuery="SELECT ErrorMessage FROM Base.ErrorLog where ErrorOccuredDate='"+date+"'";
		...
		public static String getEntityStateICNOutputFileFromDatabase(String dbServerName,String fredDBName,String templateFilePath,String ICNFilepath,String fredaixmlTmpltFilename,String ICNFileName,String fredAIXMLFilePath,String aixmlArchvFilePath) throws Exception{
			...
			System.out.println("ICNOutputFilename :"+ICNFilepath+ICNFileName);
			String entityStateVal = ReadSQLFileUtil.getSQLFileTagValues(ICNFilepath,ICNFileName+".xml",startTag,endTag);
...
//					int index = actualItemHistoryAmountVal.indexOf(".");
		...
		*/
		...
		public static void validateAIXMLValuesWithDB(String dbServerName,String fredDatabaseName,String templateFilePath,String strICNFilePath,String aixmlTempFileName,String strICNXMLFileName,String strAIXMLFilePath,String strAIXMLArchiveFldrPathKey){
			...
			validateAIXMLJobCollectionEndTimeWithDb(dbServerName,fredDatabaseName,templateFilePath,strICNFilePath,aixmlTempFileName,strICNXMLFileName,strAIXMLFilePath,strAIXMLArchiveFldrPathKey);
