 ...
 *
 */
public class DEBValidationScenarios extends GenericMethodUtilis{
...
public static boolean validateWeekDay(String TagActualValue){
	String TagExpectedPatternMatch = TagActualValue;
	if(TagExpectedPatternMatch.equalsIgnoreCase("MO") || TagExpectedPatternMatch.equalsIgnoreCase("TU")|| TagExpectedPatternMatch.equalsIgnoreCase("WE")|| TagExpectedPatternMatch.equalsIgnoreCase("TH")|| TagExpectedPatternMatch.equalsIgnoreCase("FR"))
	{
		resultFlag = true;
		publishResults(resultFlag, TagExpectedPatternMatch, "MO,TU,WE,Th,FR", "WeekDay validation");
	}else {
		resultFlag = false;
		publishResults(resultFlag, TagExpectedPatternMatch, "MO,TU,WE,Th,FR" , "WeekDay validation");
	}		
...
public static boolean validatePostingSource(String postSourceTagActualValue){
